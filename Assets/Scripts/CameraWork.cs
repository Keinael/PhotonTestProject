...
namespace Assets.Scripts
{
    public class CameraWork : MonoBehaviour 
    {
        ...
        [Tooltip("Allow the camera to be offseted verticaly from the target")]
        public Vector3 centerOffset = Vector3.zero;

        [Tooltip(
            "Set this as false if a component of a prefab being instanciated by Photon Network, and manyally call OnStartFollofing() when and if needed.")]
